...
@Composable
private fun StatusChip(status: SessionConnectionStatus, onClick: () -> Unit) {
    val label = when (status) {
        ...
        is SessionConnectionStatus.Failed -> "Failed (查看详情)"
    }
    AssistChip(
        onClick = onClick,
        enabled = status is SessionConnectionStatus.Failed,
